...
class AddEditNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (noteType.equals("Edit")){
            ...
            addupdateBtn.setText("Update Catatan")
            noteTitleEdt.setText(noteTitle)
            noteDescriptionEdt.setText(noteDesc)
        }else{
            addupdateBtn.setText("Simpan Catatan")
        }
        addupdateBtn.setOnClickListener{
            ...
            if (noteType.equals("Edit")){
                if (noteTitle.isNotEmpty() && noteDescription.isNotEmpty()){
                    ...
                    Toast.makeText(this,"Catatan berhasil diupdate",Toast.LENGTH_LONG).show()
               ...
               if(noteTitle.isNotEmpty() && noteDescription.isNotEmpty()){
                   ...
                   Toast.makeText(this,"Berhasil menambahkan note", Toast.LENGTH_LONG).show()
               }
            }
